...
%
% $Id: sgp2.tex,v 1.5 2000-10-12 20:09:57 jabril Exp $
%  
...
\begin{center}
{\Large\sgp}\\[1ex]
{\large\verb+$Id: sgp2.tex,v 1.5 2000-10-12 20:09:57 jabril Exp $+}\\[2ex]
\end{center}
...
my $PROGRAM = "sgp2";
my @tmp_ver = split / +/, ' $Id: sgp2.tex,v 1.5 2000-10-12 20:09:57 jabril Exp $ ';
...
sub check_fasta_format() \{
    ...
    return $n;
\}
\nwindexdefn{\nwixident{{\&}exits{\_}file}}{:amexits:unfile}{NWsgp9-getC-1}\nwindexdefn{\nwixident{{\&}check{\_}fasta{\_}format}}{:amcheck:unfasta:unformat}{NWsgp9-getC-1}\eatline
\nwused{\\{NWsgp9-getB-1}}\nwidentdefs{\\{{\nwixident{{\&}check{\_}fasta{\_}format}}{:amcheck:unfasta:unformat}}\\{{\nwixident{{\&}exits{\_}file}}{:amexits:unfile}}}\nwendcode{}\nwbegindocs{24}%$

{\Tt{}exits{\_}file()} : Given a list of filenames, this function returns how many among them does exist.
...
\nwalsodefined{\\{NWsgp9-set9-2}}\nwused{\\{NWsgp9-getB-1}}\nwidentuses{\\{{\nwixident{{\&}check{\_}fasta{\_}format}}{:amcheck:unfasta:unformat}}\\{{\nwixident{{\&}exits{\_}file}}{:amexits:unfile}}\\{{\nwixident{{\$}Loc1}}{:doLoc1}}\\{{\nwixident{{\$}Loc2}}{:doLoc2}}\\{{\nwixident{{\$}seq1}}{:doseq1}}\\{{\nwixident{{\$}seq2}}{:doseq2}}\\{{\nwixident{{\$}Seq1{\_}Name}}{:doSeq1:unName}}\\{{\nwixident{{\$}Seq2{\_}Name}}{:doSeq2:unName}}\\{{\nwixident{{\$}SGPTMP}}{:doSGPTMP}}\\{{\nwixident{{\$}SGPtmp1}}{:doSGPtmp1}}\\{{\nwixident{{\$}SGPtmp2}}{:doSGPtmp2}}\\{{\nwixident{{\$}SGPtmpG}}{:doSGPtmpG}}}\nwindexuse{\nwixident{{\&}check{\_}fasta{\_}format}}{:amcheck:unfasta:unformat}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\&}exits{\_}file}}{:amexits:unfile}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\$}Loc1}}{:doLoc1}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\$}Loc2}}{:doLoc2}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\$}seq1}}{:doseq1}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\$}seq2}}{:doseq2}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\$}Seq1{\_}Name}}{:doSeq1:unName}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\$}Seq2{\_}Name}}{:doSeq2:unName}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\$}SGPTMP}}{:doSGPTMP}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\$}SGPtmp1}}{:doSGPtmp1}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\$}SGPtmp2}}{:doSGPtmp2}{NWsgp9-set9-1}\nwindexuse{\nwixident{{\$}SGPtmpG}}{:doSGPtmpG}{NWsgp9-set9-1}\nwendcode{}\nwbegindocs{30}\nwdocspar
...
\nwenddocs{}\nwbegincode{33}\sublabel{NWsgp9-set9-2}\nwmargintag{{\nwtagstyle{}\subpageref{NWsgp9-set9-2}}}\moddef{set flags~{\nwtagstyle{}\subpageref{NWsgp9-set9-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWsgp9-getB-1}}\nwprevnextdefs{NWsgp9-set9-1}{\relax}\nwenddeflinemarkup
$blast_flg  = 0;
$hsps_flg   = 0;
$geneid_flg = 0;
$plots_flg  = 0;
\nwused{\\{NWsgp9-getB-1}}\nwidentuses{\\{{\nwixident{{\$}blast{\_}flg}}{:doblast:unflg}}\\{{\nwixident{{\$}geneid{\_}flg}}{:dogeneid:unflg}}\\{{\nwixident{{\$}hsps{\_}flg}}{:dohsps:unflg}}\\{{\nwixident{{\$}plots{\_}flg}}{:doplots:unflg}}}\nwindexuse{\nwixident{{\$}blast{\_}flg}}{:doblast:unflg}{NWsgp9-set9-2}\nwindexuse{\nwixident{{\$}geneid{\_}flg}}{:dogeneid:unflg}{NWsgp9-set9-2}\nwindexuse{\nwixident{{\$}hsps{\_}flg}}{:dohsps:unflg}{NWsgp9-set9-2}\nwindexuse{\nwixident{{\$}plots{\_}flg}}{:doplots:unflg}{NWsgp9-set9-2}\nwendcode{}\nwbegindocs{34}\nwdocspar


\subsctn{Printing help: {\Tt{}prt{\_}Help()}}

\nwenddocs{}\nwbegincode{35}\sublabel{NWsgp9-decC-4}\nwmargintag{{\nwtagstyle{}\subpageref{NWsgp9-decC-4}}}\moddef{declare uses~{\nwtagstyle{}\subpageref{NWsgp9-decC-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWsgp9-sgp7-1}}\nwprevnextdefs{NWsgp9-decC-3}{NWsgp9-decC-5}\nwenddeflinemarkup
use Pod::Text;
\nwused{\\{NWsgp9-sgp7-1}}\nwendcode{}\nwbegindocs{36}\nwdocspar
...
\nwindexdefn{\nwixident{{\$}status}}{:dostatus}{NWsgp9-decH-5}\nwindexdefn{\nwixident{{\$}BlastProgram}}{:doBlastProgram}{NWsgp9-decH-5}\nwindexdefn{\nwixident{{\$}PressdbProgram}}{:doPressdbProgram}{NWsgp9-decH-5}\nwindexdefn{\nwixident{{\$}BlosumMatrix}}{:doBlosumMatrix}{NWsgp9-decH-5}\nwindexdefn{\nwixident{{\$}BlastOptions}}{:doBlastOptions}{NWsgp9-decH-5}\nwindexdefn{\nwixident{@pressdb}}{@pressdb}{NWsgp9-decH-5}\nwindexdefn{\nwixident{{\$}pressdb}}{:dopressdb}{NWsgp9-decH-5}\nwindexdefn{\nwixident{@blast}}{@blast}{NWsgp9-decH-5}\nwindexdefn{\nwixident{{\$}blast}}{:doblast}{NWsgp9-decH-5}\eatline
\nwused{\\{NWsgp9-sgp7-1}}\nwidentdefs{\\{{\nwixident{{\$}blast}}{:doblast}}\\{{\nwixident{@blast}}{@blast}}\\{{\nwixident{{\$}BlastOptions}}{:doBlastOptions}}\\{{\nwixident{{\$}BlastProgram}}{:doBlastProgram}}\\{{\nwixident{{\$}BlosumMatrix}}{:doBlosumMatrix}}\\{{\nwixident{{\$}pressdb}}{:dopressdb}}\\{{\nwixident{@pressdb}}{@pressdb}}\\{{\nwixident{{\$}PressdbProgram}}{:doPressdbProgram}}\\{{\nwixident{{\$}status}}{:dostatus}}}\nwidentuses{\\{{\nwixident{{\$}SGP2param}}{:doSGP2param}}}\nwindexuse{\nwixident{{\$}SGP2param}}{:doSGP2param}{NWsgp9-decH-5}\nwendcode{}\nwbegindocs{48}%$
...
\nwindexdefn{\nwixident{{\$}GeneidProgram}}{:doGeneidProgram}{NWsgp9-decH-6}\nwindexdefn{\nwixident{{\$}GeneidParam}}{:doGeneidParam}{NWsgp9-decH-6}\nwindexdefn{\nwixident{{\$}GeneidOptions}}{:doGeneidOptions}{NWsgp9-decH-6}\nwindexdefn{\nwixident{@geneid}}{@geneid}{NWsgp9-decH-6}\nwindexdefn{\nwixident{{\$}geneid}}{:dogeneid}{NWsgp9-decH-6}\eatline
