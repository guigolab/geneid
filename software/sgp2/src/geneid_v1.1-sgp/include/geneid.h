...
/* $Id: geneid.h,v 1.1 2003-09-10 14:53:33 gparra Exp $ */
...
#define RSITES 3                 /* One signal per L / RSITES bp         */
...
#define RFIRST 0.5                 /* Ratios according to every exon type  */
#define RINTER 0.25
#define RTERMI 0.5
#define RSINGL 2 
#define RORF   3
...
#define MAXEVIDENCES 200000       /* Maximum number of annotations        */
#define MAXSR 200000              /* Maximum number of SR (strand/frame)  */
...
#define NULL_OLIGO_SCORE  -1     /* Markov score penalty: N's            */
...
#define VERSION   "sgp2_v1.0"  /* The name of the game                 */
#define SITES     "sgp2_v1.0"  /* gff fields: source and feature       */
#define EXONS     "sgp2_v1.0"        
