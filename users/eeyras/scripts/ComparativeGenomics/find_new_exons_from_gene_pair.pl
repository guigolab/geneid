...
my $human_file = "/home/ug/eeyras/Projects/ATD/ComparativeGenomics/HumanMouse/noNT.human.gtf";
my $mouse_file = "/home/ug/eeyras/Projects/ATD/ComparativeGenomics/HumanMouse/noNT.mouse.gtf";

unless ( $human_id && $mouse_id ){
    print STDERR "Usage: $0 human.gtf mouse.gtf\n";
    exit(0);
}
...
unless ($gene1 && $gene2){
    print print "NT_ORTHOLOGY\t$human_id\t$mouse_id\n";
    exit(0);
}
