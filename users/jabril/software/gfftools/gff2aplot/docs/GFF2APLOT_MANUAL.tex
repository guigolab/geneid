...
%        1         2         3         4         5         6         7         8
%
% $Id: GFF2APLOT_MANUAL.tex,v 1.6 2002-12-24 13:41:33 jabril Exp $
%
...
\newcommand{\sAppendix}[1]{}%nothing to show
...
{\large$<$\verb$Id: GFF2APLOT_MANUAL.tex,v 1.6 2002-12-24 13:41:33 jabril Exp $$>$ }
...
%\geometry{noheadfoot}
%\addtocontents{toc}{\protect\vskip 4ex\protect\noindent\protect\textbf{\protect\Large Appendixes}\protect\vskip 0.25ex}

\enlargethispage*{2cm}

\sctn{Command-Line Options Summary for \protect\prog.}
%\vskip -0.25cm
...
\pa{float}     &
  A float value. \\
\pa{string}    &
  A free text string, single or double-quoted
...
\sctn{Customization Variables Sumary for \protect\prog.}
...
% \vskip 1cm
  ...
  \input tables/AplotCFvars_tblextra.tex
