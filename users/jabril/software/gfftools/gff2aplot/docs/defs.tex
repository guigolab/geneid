...
\def\todoELB{
DATA STRUCTURE for vectors within {\tt{}{\char37}GFF{\char95}DATA} at elements level.
} % todoELB
\def\todoIAA{
...
\def\todoJAB{
Re-define the color palette, including verypale/pale/.../deep/verydeep (four extra color intensities). Look for new color gradients: khaki, pink, ...
} % todoJAB
\def\todoJBB{
...
\def\todoYAA{
Write tests to check functions, to build the examples. Maybe {\tt{}configure} or {\tt{}Makefile} scripts.
} % todoYAA
\def\todoTAA{
