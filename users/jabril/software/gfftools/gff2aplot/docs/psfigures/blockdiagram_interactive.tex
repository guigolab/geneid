...
%        1         2         3         4         5         6         7         8
%
% $Id: blockdiagram_interactive.tex,v 1.1 2003-02-05 16:17:52 jabril Exp $
%
% T='blockdiagram_interactive'; latex $T.tex; dvips $T.dvi -o $T.tmp.ps; ps2ps $T.tmp.ps $T.ps;
...
\begin{pspicture}(28,19)%
 ...
 % 
 \rput[b](15.75,3.05){\rnode{CON}{\myboxB{verylightskyblue}{Console\\Interface}}}% 
 \nccurve[angleA=-90,angleB=45,linewidth=1.5pt,linecolor=darklimegreen]{->}{PB}{CON}%
 \nccurve[angleA=185,angleB=-5,ncurvA=0.5,linewidth=1.5pt,linecolor=darklimegreen]{->}{CON}{VP}%
 \nccurve[angleA=180,angleB=-90,ncurvA=2,ncurvB=1,linewidth=1.5pt,linecolor=darklimegreen]{->}{CON}{DP}%
 % 
 \rput(15.75,2){\rnode{COM}{\myboxA{verylightviolet}{Console Commands}}}% 
 \ncarc[angleA=-88,angleB=88,linewidth=2pt,arcangle=10,linecolor=verydarklimegreen]{->}{CON}{COM}
 \ncarc[angleA=-92,angleB=92,linewidth=2pt,arcangle=-10,linecolor=verydarklimegreen]{<-}{CON}{COM}
 % 
 \rput[b](18.25,3.05){\rnode{EX}{\myboxB{verylightred}{\textcolor{darkred}{EXIT}}}}%
 \ncline[angleA=-90,angleB=90,linewidth=1.5pt,linecolor=darklimegreen]{->}{CON}{EX}%
 %
 ...
 %
 \rput(14,-0.5){{\large\bfseries \Verb|>>| blockdiagram\_interactive.ps \Verb|<<|}}
\end{pspicture}%
}%fbox
\end{center}%
\end{landscape}%
