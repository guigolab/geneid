...
%        1         2         3         4         5         6         7         8
%
% $Id: flowchart_settingvariables.tex,v 1.2 2003-02-05 16:17:52 jabril Exp $
%
...
%
     \rnode{A}{\mapsbx{\UseVerb{parsecommandline}}} &  & \rnode{B}{\mbpsbx{\UseVerb{setinputfile}}} & \rnode{vB}{\UseVerb{DATAF}} & \mapsbx{\rnode{vBB}{\UseVerb{parseGFFfiles}}} \\
      ...
      & \hspace{1cm}\rnode{vGG}{\UseVerb{varscheck}}\\
      & \rnode{vG}{\mdpsbx{\UseVerb{CUSVARS}}} & \rnode{vEE}{\mdpsbx{\UseVerb{DEFAULT}}} & \rnode{vF}{\mdpsbx{\UseVerb{COMVARS}}} & \hspace{4cm}\pnode{pBB}\\[1cm] % \hspace{1cm}\rnode{vCG}{\UseVerb{varscheck}}\hspace{1cm}\pnode{pBB}\\[1cm]
...
%
   ...
   \nccurve[angleA=-15,angleB=-1,ncurvA=1.25,ncurvB=0.5,nodesepA=10pt]{C}{vCC}
   \psset{arrows=<->,linecolor=black,linewidth=1pt,nodesep=5pt}
%   \ncline{G}{vGG}
%   \ncline{vCC}{vCG}
   \nccurve[angleA=-10,angleB=180,ncurvA=0.05,linestyle=dotted]{G}{vGG}
   \nccurve[angleA=-115,angleB=0,ncurvA=0.25,linestyle=dotted]{vCC}{vGG}
% 
...
%   \ncarc[angleA=-20,angleB=20,arcangle=65]{E}{vEE}
   \nccurve[angleA=180,angleB=60]{vE}{vGG}
%
...
%
 ...
 %
 \rput(14,-0.5){{\large\bfseries \Verb+>>+ flowchart\_settingvariables.ps \Verb+<<+}}
\end{pspicture}
}%fbox
\end{center}
\end{landscape}
