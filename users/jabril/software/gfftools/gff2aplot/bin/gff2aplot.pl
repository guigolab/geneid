...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#
# $Id: gff2aplot.pl,v 1.2 2002-02-01 19:13:54 jabril Exp $
#
#
# MODULES
#
...
/FTz @{ $vr->{feature_label_fontsize} } D /FTf { FTz $Fonts{$vr->{feature_label_font}} } D /FTp 2 pt 10 pt FTz 0.5 mul zlim D /FTXw FTz 0 gt { $vr->{feature_x_label_length} FTf glblw } { 0 } ifelse D /FTXa $vr->{feature_x_label_angle} D /FTXrb @{[ &tobool($vr->{feature_x_label_rotate}) ]} D /FTYw FTz 0 gt { $vr->{feature_y_label_length} FTf glblw } { 0 } ifelse D /FTYa $vr->{feature_y_label_angle} D /FTYrb @{[ &tobool($vr->{feature_y_label_rotate}) ]} D
/GPz @{ $vr->{group_label_fontsize} } D /GPf { GPz $Fonts{$vr->{group_label_font}} } D /GPp 4 pt 16 pt GPz 0.75 mul zlim D /GPpt GPp 0.25 mul D /GPXw GPz 0 gt { $vr->{group_x_label_length} GPf glblw } { 0 } ifelse D /GPXa $vr->{group_x_label_angle} D /GPXrb @{[ &tobool($vr->{group_x_label_rotate}) ]} D /GPYw GPz 0 gt { $vr->{group_y_label_length} GPf glblw } { 0 } ifelse D /GPYa $vr->{group_y_label_angle} D /GPYrb @{[ &tobool($vr->{group_y_label_rotate}) ]} D
