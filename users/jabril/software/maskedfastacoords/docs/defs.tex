...
\def\bioseqlarge{\htmladdnormallinkfoot{\texttt{Bio::Seq::LargeSeq}}{http://bioperl.org/Core/POD/Bio/Seq/LargeSeq.html}}
...
\def\todoCCD{It will be also necessary to define the parsing functions for largeseq in a different way from default fasta sequences.} % todoCCD
