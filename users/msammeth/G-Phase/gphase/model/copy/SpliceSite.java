...
public class SpliceSite extends AbstractSite {
	...
	Exon[] exons= null;
	HashMap<Exon, Exon> exonHash= null;
	...
	public boolean addExon(Exon newExon) {
		...
		if ((getGene()== null&& newExon.getTransHash()!= null)|| (getGene()!= null&& getGene().isConstruct())) {
			addTranscripts(newExon.getTransHash());
			if (exonHash== null)
				exonHash= new HashMap<Exon, Exon>(1,1f);
			if (exonHash.get(newExon)!= null)
				return false;
			exonHash.put(newExon, newExon);
			return true;
...
//	----------------------------------------------
	...
	public Exon[] getExons() {
		if (exons== null&& exonHash!= null) {
			exons= new Exon[exonHash.size()];
			Object[] o= exonHash.keySet().toArray();
...
//				return true;
	...
	public HashMap<Exon, Exon> getExonHash() {
		return exonHash;
	}

	public void setExonHash(HashMap<Exon, Exon> exonHash) {
