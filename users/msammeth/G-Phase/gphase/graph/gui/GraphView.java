...
public class GraphView extends JPanel {
    ...
    public GraphView(String label1, Graph g1, String label2, Graph g2) {
        
        
        // --------------------------------------------------------------------        
        // launch the visualization
        
    	Display display= createDisplay(g1, label1);	// outputs INFOs
    	Display display2= createDisplay(g2, label2);
        // JPanel fpanel= createControls();

        // create a new JSplitPane to present the interface
        JSplitPane split = new JSplitPane();
        split.setLeftComponent(display);
        split.setRightComponent(display2);	// fpanel
    ...
    Display createDisplay(Graph g, String label) {
        // create a new, empty visualization for our data
        final Visualization m_vis = new Visualization();
        createControls(m_vis);
...
//        overview.addItemBoundsListener(new FitOverviewListener());
    ...
    JPanel createControls(final Visualization m_vis) {
...
//        opanel.add(overview);
    ...
    public static JFrame demo(String label1, Graph g1, String label2, Graph g2) {
        final GraphView view = new GraphView(label1, g1, label2, g2);
...
//        menubar.add(dataMenu);
        ...
        // launch window
        JFrame frame = new JFrame("Graph Diff");
