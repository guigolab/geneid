...
/**
 * Implementation of the AffyFeature type.
 *
 * @author <a href="mailto:craig@ebi.ac.uk">Craig Melsopp</a>
 */
public class AffyFeatureImpl extends BaseFeatureImpl implements AffyFeature {
  ...
  private static final long serialVersionUID = 1L;
	 ...
	 * @param misMatchSize
	 */
	public AffyFeatureImpl(Driver driver, long internalID, Location location,
	...
	/**
	 * @see org.ensembl.datamodel.AffyFeature#getProbe()
	 */
	public AffyProbe getProbe() {
		if (probe==null && probeID>0)
			try {
				probe = driver.getAffyProbeAdaptor().fetch(probeID);
			} catch (AdaptorException e) {
				throw new RuntimeAdaptorException("Failed to lazy load Probe for AffyFeature: " + this,e);
			} 
		return probe;
	}

	/**
	 * @see org.ensembl.datamodel.AffyFeature#getMisMatchSize()
	 */
	...
	/**
	 * @see org.ensembl.datamodel.AffyFeature#getProbeInternalID()
	 */
	...
	public int compareTo(Object o) {
		...
		else return (int) (probeID-((AffyFeatureImpl)o).probeID);
	}
