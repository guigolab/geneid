...
public class SequenceImpl extends LocatableImpl implements Sequence {
  ...
  public void setSequence(Sequence sequence) {
    ...
    this.sequenceAsString = sequence.getString();
  }
  ...
  public Sequence subSequence(int relativeStart, int relativeEnd) {
    String subSeq = sequenceAsString.substring(relativeStart-1, relativeEnd);
    Sequence seq = new SequenceImpl(subSeq);
    if ( location!=null ) {
      seq.setLocation( location.transform(relativeStart-1, 
                                       relativeEnd-location.getLength()) );
    }
    return seq;
  }
  ...
  public String toString() {
    ...
    buf.append("sequence=").append(sequenceAsString).append(", ");
    buf.append("]");
