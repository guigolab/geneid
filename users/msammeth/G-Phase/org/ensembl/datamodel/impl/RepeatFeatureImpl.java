    ...
    RepeatFeature
{
  ...
  private static final long serialVersionUID = 1L;
    ...
    public RepeatFeatureImpl(long internalID, Location location, Location hitLocation) {
    ...
    private RepeatConsensus repeatConsensus;
		...
		public RepeatConsensus getRepeatConsensus(){ return repeatConsensus; }

    public void setRepeatConsensus(RepeatConsensus repeatConsensus){ this.repeatConsensus = repeatConsensus; }

    private long repeatConsensusInternalID;

    /**
		 *
		 * @return repeatConsensus.internalID if repeatConsensus set, otherwise repeatConsensusInternalID.
     */
    public long getRepeatConsensusInternalID() {
      if ( repeatConsensus!=null )
        repeatConsensusInternalID = repeatConsensus.getInternalID();
      return repeatConsensusInternalID;
    }
    
    public void setRepeatConsensusInternalID(long repeatConsensusInternalID){ 
      this.repeatConsensusInternalID = repeatConsensusInternalID; 
      if ( repeatConsensus!=null )
        repeatConsensus.setInternalID( repeatConsensusInternalID );
    }
