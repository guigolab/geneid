...
public class KaryotypeBandImpl extends BaseFeatureImpl implements KaryotypeBand{
  ...
  public KaryotypeBandImpl(Driver driver){
    super(driver);
  }
  ...
  public void setBand(String newValue){
    band = newValue;
  }
  ...
  public void setStain(String newValue){
    stain = newValue;
  }
  ...
  public String toString() {
    ...
    buf.append(", band=").append(band);
    buf.append(", stain=").append(stain);
    buf.append("]");
