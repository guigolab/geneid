...
public class BaseFeatureImpl extends LocatableImpl implements Feature {
  ...
  private static final long serialVersionUID = 1L;
	 ...
	 * @param location
	 */
	public BaseFeatureImpl(Driver driver, long internalID, Location location) {
		super(driver);
	...
	/**
	 * Convenience method for accessing analysis.internalID.
	 * @return analysis.internalID if analysis set, otherwise 0.
	 */
	public long getAnalysisID() {
		if (analysis == null)
			return 0;
		else
			return analysis.getInternalID();
	}
