...
/**
 * PopulationGenotype implementation.
 *
 * @author <a href="mailto:craig@ebi.ac.uk">Craig Melsopp</a>
 */
public class PopulationGenotypeImpl extends GenotypeImpl implements
		PopulationGenotype {
  ...
  private static final long serialVersionUID = 1L;
	 ...
	 * @param variationID
	 */
	public PopulationGenotypeImpl(VariationDriver vdriver, String allele1,
			String allele2, long variationID, long populationID, double frequency) {
	...
	/**
	 * @see org.ensembl.datamodel.variation.PopulationGenotype#getPopulation()
	 */
	...
	/**
	 * @see org.ensembl.datamodel.variation.PopulationGenotype#getFrequency()
	 */
