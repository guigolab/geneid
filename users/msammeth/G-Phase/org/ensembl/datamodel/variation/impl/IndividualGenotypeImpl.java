...
/**
 * IndividualGenotype implementation.
 *
 * @author <a href="mailto:craig@ebi.ac.uk">Craig Melsopp</a>
 */
public class IndividualGenotypeImpl extends GenotypeImpl implements
		IndividualGenotype {
  ...
  private static final long serialVersionUID = 1L;
	...
	/**
	 * Constructs IndividualGenotype that lazy loads variation and
	 ...
	 * @param individualID
	 */
	public IndividualGenotypeImpl(VariationDriver vdriver, String allele1,
			String allele2, long variationID, long individualID) {
		super(vdriver, allele1, allele2, variationID);
		this.individualID = individualID;
	}

	/**
	 * @see org.ensembl.datamodel.variation.IndividualGenotype#getIndividual()
	 */
	public Individual getIndividual() {
		if (individual==null && individualID>0 && vdriver!=null)
			try {
				individual = vdriver.getIndividualAdaptor().fetch(individualID);
			} catch (AdaptorException e) {
				throw new RuntimeAdaptorException("Failed to lazy load individual: " + individualID,e);
			}
		return individual;
	}
