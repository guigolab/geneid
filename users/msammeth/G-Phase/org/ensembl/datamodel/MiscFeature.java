...
public interface MiscFeature extends Feature {
  ...
  /**
   * Attributes associatted with this feature.
   * @param attributes associatted with this feature, empty list if non assocaited.
   */
  ...
  /**
   * MiscSets associated with this feature.
   * @param miscSets MiscSets associated with this feature, or empty list if non associatted.
   */
  void setMiscSets(List miscSets);
