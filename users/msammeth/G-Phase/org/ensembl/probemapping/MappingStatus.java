 ...
 * file.
 * 
 * @see org.ensembl.probemapping.MappableAffyFeature
...
public class MappingStatus {
	...
	/**
	 * Create a status for the mapping between the composite and the transcript.
	 * 
	 * @param probeSet
	 * @param exonFlankHitThreshold
	 * @param transcript
	 * @param exonFlankHitCount
	 * @param intronHitCount
	 * @param reverseStrandHitCount
	 */
	...
	public int getProbeSetSize() {
		return ((AffyArray) probeSet.arrays.get(0)).getProbeSetSize();
	}
