...
/**
 * Thrown when an problem occurs executing a method on an adaptor.
 */
public class RuntimeAdaptorException extends RuntimeException {
  ...
  public RuntimeAdaptorException(String message) {
    super(message);
  }

  public RuntimeAdaptorException(String message, Exception parentException) {
