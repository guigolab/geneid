...
/**
 * Drivers represent single datasets and provide access to them via adaptors.
 * 
 * <p>
 * Drivers are created and, where needed, should be initialised() <b>before </b>
 * any of the getXXXX() methods are called.
 */
public interface Driver extends EnsemblDriver {
	...
	/**
	 * @return default QueryAdaptor if available otherwise null.
	 */
	QueryAdaptor getQueryAdaptor() throws AdaptorException;
	...
	/**
	 * @return default AffyProbeAdaptor if available, otherwise null.
	 */
	AffyProbeAdaptor getAffyProbeAdaptor() throws AdaptorException;

	/**
	 * @return default AffyFeatureAdaptor if available, otherwise null.
	 */
	AffyFeatureAdaptor getAffyFeatureAdaptor() throws AdaptorException;

	/**
	 * @return default AffyArrayAdaptor if available, otherwise null.
	 */
	AffyArrayAdaptor getAffyArrayAdaptor() throws AdaptorException;
