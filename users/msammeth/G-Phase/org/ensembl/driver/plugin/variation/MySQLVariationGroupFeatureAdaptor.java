...
import org.ensembl.datamodel.variation.VariationGroupFeature;
import org.ensembl.datamodel.variation.impl.VariationGroupFeatureImpl;
 ...
 * @see org.ensembl.datamodel.variation.VariationGroupFeature
 */
public class MySQLVariationGroupFeatureAdaptor extends MySQLBaseFeatureAdaptor
	...
	public MySQLVariationGroupFeatureAdaptor(VariationDriver vdriver) {
		// TODO consider changing baseadaptor to handle Driver instead of
		// MySQLDriver
		...
		try {
			if (rs.next()) {
				...
				vgf = new VariationGroupFeatureImpl(vdriver,
						loc, rs.getLong("vgf.variation_group_id"), rs
								.getString("vgf.variation_group_name"));
				vgf.setInternalID(rs.getLong("vgf.variation_group_feature_id"));
	...
	/**
	 * @see org.ensembl.driver.variation.VariationGroupFeatureAdaptor#fetch(long)
	 */
