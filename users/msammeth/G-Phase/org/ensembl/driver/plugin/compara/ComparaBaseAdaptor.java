...
public abstract class ComparaBaseAdaptor implements Adaptor {
  ...
  private ComparaMySQLDriver driver;
  ...
  public ComparaBaseAdaptor(ComparaMySQLDriver driver) {
    this.driver = driver;
  }
  ...
  public ComparaMySQLDriver getDriver(){
    return driver;
  }//end getDriver
  ...
  **/
  ...
  public void setDriver(ComparaMySQLDriver newValue){
    driver = newValue;
  }//end setDriver
  ...
  **/
  ...
  throws AdaptorException
  {
    try{
      ...
      return connection.prepareStatement(getDeleteStatementString());
    }catch(SQLException exception){
      throw new AdaptorException("Problem creating delete statement", exception);
    }
  }//end createDeleteStatement
  ...
  throws AdaptorException
  {
    try{
      ...
      return connection.prepareStatement(getSelectAllStatementString());
    }catch(SQLException exception){
      throw new AdaptorException("Problem creating select all statement", exception);
    }
  ...
  **/
  ...
  throws AdaptorException
  {
    try{
      ...
      return connection.prepareStatement(getSelectStatementString());
    }catch(SQLException exception){
      throw new AdaptorException("Problem creating select statement", exception);
    }
  ...
  throws AdaptorException
  {
    try{
      ...
      return connection.prepareStatement(getInsertStatementString());
    }catch(SQLException exception){
      throw new AdaptorException("Problem creating insert statement", exception);
    }
  ...
  throws AdaptorException
  {
    try{
      ...
      return connection.prepareStatement(getUpdateStatementString());
    }catch(SQLException exception){
      throw new AdaptorException("Problem creating update statement", exception);
    }
  ...
  **/
  protected PreparedStatement prepareStatement(String statementText) throws AdaptorException{
    PreparedStatement statement = null;
    try{
      statement = getConnection().prepareStatement(statementText.toString());
  ...
  **/
  protected PreparedStatement prepareSelectWithWhereClause(String statementKey) 
  throws AdaptorException{
    PreparedStatement statement = null;
    StringBuffer statementText = null;
    statementText = createSelectUpToWhere().append(statementKey);
    statement = prepareStatement(statementText.toString());
    return statement;
 ...
 public PersistentImpl fetch(Object id) throws AdaptorException{
    PreparedStatement statement = createSelectStatement(getConnection());
  ...
  **/
  public List fetch() throws AdaptorException{
    ...
    try{
      statement = createSelectAllStatement(getConnection());
      set  = statement.executeQuery();
  ...
  public void store(Persistent persistentObject) throws AdaptorException{
    PreparedStatement statement = createInsertStatement(getConnection());
    ResultSet set;
