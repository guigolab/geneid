...
**/
public class MySQLMethodLinkAdaptor extends ComparaBaseAdaptor implements MethodLinkAdaptor{
  ...
  public MySQLMethodLinkAdaptor(ComparaMySQLDriver driver) {
    super(driver);
  ...
  **/
  ...
  private void fillCache() throws AdaptorException{
    ...
    getLogger().fine("filling cache for MySQLMethodLinkAdaptor");
  ...
  **/
  protected void mapColumnsToObject(HashMap columns, Persistent object) {
    ...
    methodLink.setInternalID(((Integer)columns.get(METHOD_LINK_ID)).intValue());
