 ...
 *
 */
public class MySQLKaryotypeBandAdaptor
  extends MySQLBaseFeatureAdaptor
  implements KaryotypeBandAdaptor {

  public MySQLKaryotypeBandAdaptor(MySQLDriver driver) {
    super(driver, TYPE);
  }
  ...
  public List fetch(CoordinateSystem coordSys, String chromosome) throws AdaptorException, InvalidLocationException {
    ...
    return fetchAllByConstraint( new Location(coordSys, chromosome),"");
  }
  ...
  public List fetch(
    ...
    return fetchAllByConstraint( new Location(coordSys, chromosome),constraint);
  }
