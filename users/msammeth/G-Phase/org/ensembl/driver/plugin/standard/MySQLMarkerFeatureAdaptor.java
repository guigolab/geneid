 ...
 */
public class MySQLMarkerFeatureAdaptor
  extends MySQLBaseFeatureAdaptor
  implements MarkerFeatureAdaptor {

  public MySQLMarkerFeatureAdaptor(MySQLDriver driver) {
    super(driver, TYPE);
  }
  ...
  public Object createObject(ResultSet rs) throws AdaptorException {
    ...
    try {
      if (rs.next()) {
        ...
        mf.setMapWeight(rs.getInt("mf.map_weight"));
        mf.setAnalysis(
          driver.getAnalysisAdaptor().fetch(rs.getLong("mf.analysis_id")));
