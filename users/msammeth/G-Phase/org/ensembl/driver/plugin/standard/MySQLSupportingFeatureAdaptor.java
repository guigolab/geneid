...
public class MySQLSupportingFeatureAdaptor
  extends BaseAdaptor
  implements SupportingFeatureAdaptor {
  private static final Logger logger =
    Logger.getLogger(MySQLSupportingFeatureAdaptor.class.getName());

  public MySQLSupportingFeatureAdaptor(MySQLDriver driver) {
    super(driver);
  }

  /**
   *  Gets the type attribute of the MySQLSupportingFeatureAdaptor object
