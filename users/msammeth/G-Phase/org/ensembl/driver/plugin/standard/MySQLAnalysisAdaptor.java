...
public class MySQLAnalysisAdaptor
  extends BaseAdaptor
  implements AnalysisAdaptor {
  private final static Logger logger =
    Logger.getLogger(MySQLAnalysisAdaptor.class.getName());


  /**
   *  Constructor for the MySQLAnalysisAdaptor object
   *@param  driver  Description of Parameter
   */
  public MySQLAnalysisAdaptor(MySQLDriver driver) {
  ...
  /**
   *  Gets the type attribute of the MySQLAnalysisAdaptor object
