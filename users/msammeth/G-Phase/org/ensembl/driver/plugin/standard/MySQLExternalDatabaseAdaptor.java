...
public class MySQLExternalDatabaseAdaptor extends BaseAdaptor implements
		ExternalDatabaseAdaptor {
	private static final Logger logger = Logger
			.getLogger(MySQLExternalRefAdaptor.class.getName());

	private boolean cachePreloaded = false;

	public MySQLExternalDatabaseAdaptor(MySQLDriver driver) {
		super(driver, 1000);
	}
	...
	private ExternalDatabase fetchByConstraint(String constraint)
		...
		try {
			...
			while (rs.next()) {
				...
				externalDatabase.setVersion(rs.getString("release"));
