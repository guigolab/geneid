  ...
  PredictionExonAdaptor 
{
  ...
  private static final Logger logger = Logger.getLogger(MySQLPredictionExonAdaptor.class.getName());
  ...
  public MySQLPredictionExonAdaptor(MySQLDriver driver, String logicName, String type) {
    super(driver, logicName, type);
  }

  public MySQLPredictionExonAdaptor(MySQLDriver driver, String[] logicNames, String type) {
    super(driver, logicNames, type);
  }

  public MySQLPredictionExonAdaptor(MySQLDriver driver) {
    super(driver, TYPE);
  }
