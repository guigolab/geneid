...
public class MySQLSimpleFeatureAdaptor extends MySQLBaseFeatureAdaptor implements SimpleFeatureAdaptor {

	private static final Logger logger = Logger.getLogger(MySQLSimpleFeatureAdaptor.class.getName());
	public final boolean CLIP = false;

	private String analysisIDCondition;

	public MySQLSimpleFeatureAdaptor(MySQLDriver driver, String logicName, String type) {
		super(driver, logicName, type);
		analysisIDCondition = null;
	}

	public MySQLSimpleFeatureAdaptor(MySQLDriver driver, String[] logicNames, String type) {
		super(driver, logicNames, type);
	}

	public MySQLSimpleFeatureAdaptor(MySQLDriver driver) {
		super(driver, TYPE);
	}
	...
	public Object createObject(ResultSet rs) throws AdaptorException {
		...
		try {
			if (rs.next()) {
				...
				sf.setDisplayName(rs.getString("sf.display_label"));
				sf.setScore(rs.getDouble("sf.score"));
				sf.setAnalysis(analysisAdaptor.fetch(rs.getLong("sf.analysis_id")));
