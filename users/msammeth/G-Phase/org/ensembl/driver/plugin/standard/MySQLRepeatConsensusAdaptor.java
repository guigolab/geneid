...
public class MySQLRepeatConsensusAdaptor
  extends BaseAdaptor
  implements RepeatConsensusAdaptor {
  private static final Logger logger =
    Logger.getLogger(MySQLRepeatConsensusAdaptor.class.getName());

  /**
   * creates adaptor with a cache.
   */
  public MySQLRepeatConsensusAdaptor(MySQLDriver driver) {
    super(driver, 2000);
  }
