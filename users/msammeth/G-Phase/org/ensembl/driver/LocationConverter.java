...
public interface LocationConverter extends java.rmi.Remote, Adaptor {
	...
	* to the sourceLocation.
	...
	/**
	 * Converts location to the specified map, the returned location does not have gaps.
	...
	/**
	 * Standard conversion with all gaps and all nodes
	 * @param loc
	 * @param cs
	...
	/**
	 * Resolve linked regions in Location.
	 * @param loc
	 * @return Either a new Location if there are links on the same sequence Region or
	 * the same Location if there arent
	 * @throws AdaptorException
	 */
	public Location dereference(Location loc) throws AdaptorException;

	/**
	 * Converts location to the specified map.
	 * @return location translated into map coordinates, or null if no
	 * equivalent exists.
	 */
	Location convert(
