...
##################################################################
#
# k-mean algorithm Moby Service Client
#
##################################################################
...
sub help {
return <<"END_HELP";
Description: Execute runKMeansClustering MOBY service
Usage:
...
my $result = $Service->execute(XMLinputlist => [
						["$articleName", $score_matrix_xml, "clusters number", $cluster_number_xml]
					       ]);
