...
my $in_file_1  = shift @ARGV || "/home/ug/arnau/projects/biomoby/gostat/data/mut1_downreg.fbgn";
my $in_file_2  = shift @ARGV || "/home/ug/arnau/projects/biomoby/gostat/data/allArray.fbgn";
my $datasource = "FB";
