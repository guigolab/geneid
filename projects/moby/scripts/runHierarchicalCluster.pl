...
sub help {
return <<"END_HELP";
Description: Execute runHierarchicalClustering MOBY service
Usage:

    MetaAlignment_Moby_Service.pl [-h] -x {Moby Central} -f {score matrix file}
	-h help
...
Examples using some combinations:
	perl runHierarchicalCluster.pl -x 2
...
my $serviceName = "runHierarchicalClustering";
my $articleName = "microarraydata";
