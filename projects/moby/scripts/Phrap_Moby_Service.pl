...
sub help {
return <<"END_HELP";
Description: Execute Phrap Moby services available from genome.imim.es to assemble a set of reads
Usage:

    Phrap_Moby_Service.pl [-h] -x {Moby Central} -s {Service Name} -f {sequence FASTA file}
	-h help
