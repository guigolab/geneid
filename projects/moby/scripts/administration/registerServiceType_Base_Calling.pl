...
Description: Register a service type in Moby Central
  Usage:
	...
	perl registerServiceType.pl -x 2 -t Base_Calling
...
my $serviceTypeName        = "Base_Calling";
my $serviceTypeDescription = "Services that read trace data, call bases and assigns quality values to the bases.";
