...
# Use the code module that contains MOBY Object.
...
Description: Register an object in Moby Central
  Usage:
    ...
    registerObject.pl [-h] -x {Moby Central}
    -h help
...
my $objectName = "Chromatogram_Encoded";
my $objectDescription = "Generic trace binary data object";
