...
Description: Register a service type in Moby Central
  Usage:
	...
	perl registerServiceType.pl -x 2 -t Sequence_Assembly
...
my $serviceTypeName        = "Sequence_Assembly";
my $serviceTypeDescription = "Services that assemble into contigs a set of DNA sequences";
