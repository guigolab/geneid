# $Id: MemeServices.pm,v 1.26 2006-03-21 21:18:32 gmaster Exp $
#
...
sub _do_query_Meme {
	...
	if (($articleName eq "sequences") || (isCollectionArticle ($DOM)) || ($articleName =~ /sequences/i)) {
	    ...
	    # Validate the type of the simples in the collection - should all be GenericSequence objects or below
